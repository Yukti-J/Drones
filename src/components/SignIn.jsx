...
function SignIn() {
  ...
  return (
    <div className="relative h-min flex w-screen md:w-full max-w-[24rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            ...
            >
              <form className="flex flex-col gap-4 mt-12">
                ...
                <button
                  ...
                  className="bg-teal-500 text-xl rounded-md px-10 py-2 tracking-wide text-white  hover:bg-teal-200 hover:text-black"
                >
                  Sign In
                </button>
